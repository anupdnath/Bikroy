...
new KeyValuePair<string, string>("Computer Accessories","24"),
new KeyValuePair<string, string>("Laptops & Netbooks","24"),
new KeyValuePair<string, string>("Desktop Computers","24"),
new KeyValuePair<string, string>("Tablets & Accessories","24"),
new KeyValuePair<string, string>("Cars","28"),
